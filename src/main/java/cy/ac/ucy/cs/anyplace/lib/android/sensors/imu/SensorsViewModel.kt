...
import cy.ac.ucy.cs.anyplace.lib.android.sensors.imu.sensorsCollector2.model.TYPE_SENSOR_EVENT
import cy.ac.ucy.cs.anyplace.lib.android.sensors.imu.sensorsCollector2.step.IStepDetector
import cy.ac.ucy.cs.anyplace.lib.android.sensors.imu.sensorsCollector2.step.StaticAccMagnitudeStepDetector
...
class SensorsViewModel(application: Application): AndroidViewModel(application), SensorEventListener {
    ...
    var stepDetector: IStepDetector
      get() = StaticAccMagnitudeStepDetector()
      set(value) = TODO()
