...
/**
 * SMAS Backend settings:
 * - communication settings like port, url etc.
 * - delete chat msgs
 */
@AndroidEntryPoint
class SettingsSmasServerActivity: BaseSettingsActivity() {
  companion object {
  ...
  class SettingsChatFragment(
    ...
    private val TG = "${SettingsSmasServerActivity.TG}-frgmnt"
