// MERGE:PM: (probably) there just a single point to merge: analyzeImage
...
// @AndroidEntryPoint
// @Deprecated("")
// class CvLoggerActivityRM: CvActivityBaseDN(), OnMapReadyCallback {
//
//   // FRAGMENTS
...
//
//     // setupComputerVision()
//     // setupMap() CHECK:PM done?
//     // setupButtonsAndUi()
//   }
//
//   // MERGE:PM: is readPrefsAndContinueSetup done? (with the bottom sheet?)
