...
[ModelHelpers](src/main/java/cy/ac/ucy/cs/anyplace/lib/android/data/models/helpers) accept a `Model` as a parameter and can provide any needed functionality.
The convention is to use `modelH` for the `ModelHelper` variable.

Examples:
- [SpaceHelper](src/main/java/cy/ac/ucy/cs/anyplace/lib/android/data/models/helpers/SpaceHelper.kt)
